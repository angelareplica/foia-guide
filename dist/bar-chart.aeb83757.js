...
var yPositionScale = d3.scaleLinear().domain([0, 20000]).range([height, 0]);
...
d3.csv(require('./data/rat_sightings_count_total_Nov112019.csv')).then(ready).catch(function (err) {
...
function ready(datapoints) {
  ...
  svg.selectAll('rect').data(datapoints).enter().append('rect').attr('x', function (d) {
  ...
  }).attr('y', height).attr('width', xPositionScale.bandwidth()).attr('height', 0).attr('fill', '#99A5C6').attr('opacity', '75%').on('mouseover', function (d) {
    // console.log(d)
    ...
    div.html(formatComma(+d['Unique Key']) + ' 🐀sightings').style('left', d3.event.pageX + 'px')
  ...
  var yAxis = d3.axisLeft(yPositionScale).tickSize(5).tickValues([5000, 10000, 15000, 20000]);
  // .ticks(5)
...
},{"d3":"../node_modules/d3/index.js","./data/rat_sightings_count_total_Nov112019.csv":"data/rat_sightings_count_total_Nov112019.csv"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/bar-chart.aeb83757.map