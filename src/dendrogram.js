    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: 'Appeal',
          colname: 'level3',
          description: 'You can appeal a denied request by sending a letter describing why your request should be reconsidered.'
        },
        {
          name: 'Mediation',
          colname: 'level3',
      ...
      colname: 'level2',
      description: "An agency might determine your request didn't adequately describe what documents you seek, no relevant documents exist, or the documents fall under one of FOIA's nine exemptions."
    },
    {
      name: 'No Response',
      children: [
        {
          name: 'Follow Up',
          colname: 'level3',
          description: "Reach out to the agency's FOIA officer to follow up on your request."
        },
        {
          name: 'Litigation',
          colname: 'level3',
          description: 'Filing a federal lawsuit costs $400 and necessitates a response. This is also an option if an appeal is denied.'
        }
      ],
      colname: 'level2',
      description: 'Despite the statute, you may not actually a response in 20 business days.'
    }
  ],
  name: 'Submit',
  description: 'Federal agencies have 20 working days to respond. They may deliberately ask you to clarify parts of your request, thereby delaying the clock.'
}
